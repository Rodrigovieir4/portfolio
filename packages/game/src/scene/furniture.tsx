 ...
 *
 * As posições aqui batem com os colisores de hotspots.ts. Mudou um, muda o outro.
 */
...
function Setup({ near }: { near: boolean }) {
  ...
  return (
    <group>
      <Box position={[-2.6, 0.75, -4.45]} size={[2.4, 0.06, 0.9]} color={WOOD} />
      {[
        [-3.75, -4.85],
        [-1.45, -4.85],
        [-3.75, -4.05],
      ...
      {(
        ...
        <group key={x} position={[x, 1.18, -4.7]} rotation={[0, angle, 0]}>
          <Box position={[0, 0, 0]} size={[0.95, 0.58, 0.05]} color="#0b0d12" />
          <mesh position={[0, 0, 0.028]}>
            <planeGeometry args={[0.89, 0.52]} />
            <meshBasicMaterial map={texture()} color={screenTint} toneMapped={false} />
          </mesh>
      ...
      <group position={[-2.6, 0, -3.45]}>
        <Box position={[0, 0.48, 0]} size={[0.56, 0.1, 0.56]} color="#12151c" />
        <Box position={[0, 0.98, 0.25]} size={[0.56, 0.9, 0.1]} color="#12151c" />
        <Box
...
function Whiteboard() {
  return (
    <group position={[1.6, 1.55, -4.94]}>
      <Box position={[0, 0, 0]} size={[2.12, 1.22, 0.04]} color="#9aa1ae" />
      <mesh position={[0, 0, 0.025]}>
        <planeGeometry args={[2.0, 1.1]} />
        <meshStandardMaterial map={whiteboard()} roughness={0.6} />
      </mesh>
...
function WorldMap() {
  return (
    <group position={[3.95, 1.55, -4.94]}>
      <Box position={[0, 0, 0]} size={[1.62, 1.06, 0.04]} color={WOOD} />
      <mesh position={[0, 0, 0.025]}>
        <planeGeometry args={[1.5, 0.94]} />
        <meshBasicMaterial map={worldMap()} toneMapped={false} />
      </mesh>
    </group>
  );
}
      ...
      {frames.map(([z, y], index) => (
        <group key={index} position={[-4.94, y, z]} rotation={[0, Math.PI / 2, 0]}>
          ...
          <mesh position={[0, 0, 0.02]}>
            ...
            <meshStandardMaterial map={certificate(index)} roughness={0.7} />
          </mesh>
  ...
  return (
    <group position={position} scale={scale}>
      ...
      <mesh position={[0, 0.08, 0]} castShadow>
        ...
        <meshStandardMaterial color={color} metalness={0.7} roughness={0.3} flatShading />
      </mesh>
      <mesh position={[0, 0.2, 0]} castShadow>
        <cylinderGeometry args={[0.1, 0.05, 0.16, 8]} />
        <meshStandardMaterial color={color} metalness={0.7} roughness={0.3} flatShading />
      </mesh>
      {[-1, 1].map((side) => (
        <mesh key={side} position={[side * 0.11, 0.22, 0]} rotation={[0, 0, Math.PI / 2]}>
...
function TrophyShelf({ near }: { near: boolean }) {
  ...
  return (
    <group position={[4.55, 0, -1.4]}>
      <Box position={[0.36, 0.95, 0]} size={[0.06, 1.9, 1.8]} color={WOOD} />
      <Box position={[0, 0.95, -0.88]} size={[0.8, 1.9, 0.05]} color={WOOD} />
      <Box position={[0, 0.95, 0.88]} size={[0.8, 1.9, 0.05]} color={WOOD} />
      {shelves.map((y) => (
      ...
      <mesh position={[0.32, 1.62, 0]} rotation={[0, -Math.PI / 2, 0]}>
        <planeGeometry args={[0.52, 0.6]} />
        <meshStandardMaterial map={jersey()} transparent alphaTest={0.1} />
      </mesh>
      {/* headset: o lado Counter-Strike */}
      <mesh position={[0, 1.42, -0.62]} rotation={[0, 0, 0]}>
...
function Bookcase() {
  ...
  return (
    <group position={[4.6, 0, 1.3]}>
      <Box position={[0, 0.6, 0]} size={[0.7, 1.2, 1.4]} color={WOOD} />
      {[0.35, 0.8].map((y) =>
      ...
      <group position={[-0.05, 1.42, -0.3]} rotation={[0, -Math.PI / 2, -0.12]}>
        ...
        <mesh position={[0, 0, 0.02]}>
          ...
          <meshStandardMaterial map={certificate(9)} />
        </mesh>
      </group>
      {/* capelo de formatura */}
      <group position={[-0.05, 1.28, 0.35]} rotation={[0, 0.5, 0]}>
        ...
        <mesh position={[0, 0.02, 0]}>
          <cylinderGeometry args={[0.1, 0.11, 0.08, 8]} />
          <meshStandardMaterial color="#12151c" flatShading />
        </mesh>
        <Box position={[0.14, 0.0, 0.14]} size={[0.015, 0.1, 0.015]} color={SIGNAL} />
      </group>
      {/* mochila encostada ao lado */}
      <group position={[0.1, 0, 1.0]}>
        <Box position={[0, 0.24, 0]} size={[0.26, 0.42, 0.34]} color="#2c2440" />
...
function Nightstand({ near }: { near: boolean }) {
  ...
  return (
    <group position={[-4.55, 0, 1.5]}>
      <Box position={[0, 0.3, 0]} size={[0.6, 0.6, 0.6]} color={WOOD} />
      <Box position={[0.31, 0.38, 0]} size={[0.01, 0.12, 0.3]} color={WOOD_LIGHT} />
      <mesh ref={phone} position={[-0.05, 0.615, 0.05]} rotation={[0, 0.3, 0]} castShadow>
        <boxGeometry args={[0.1, 0.014, 0.19]} />
        <meshStandardMaterial
          color="#0b0d12"
          emissive={SIGNAL}
...
function Doormat() {
  return (
    ...
    <mesh position={[0, 0.012, 4.15]} rotation={[-Math.PI / 2, 0, Math.PI / 4]} receiveShadow>
      <planeGeometry args={[1.4, 0.8]} />
      <meshStandardMaterial map={doormat()} />
    </mesh>
  );
}
...
export function Door() {
  return (
    <group position={[0, 0, 4.96]}>
      <Box position={[0, 1.05, 0]} size={[1.1, 2.1, 0.06]} color="#4a3a2a" />
      <Box position={[0, 1.05, -0.02]} size={[0.96, 1.96, 0.04]} color="#5b4735" />
      <mesh position={[0.36, 1.0, -0.06]}>
  ...
  return (
    <group position={[-4.5, 0, -4.5]}>
      ...
      <mesh position={[0, 0.8, 0]} castShadow>
        <cylinderGeometry args={[0.02, 0.02, 1.56, 6]} />
        <meshStandardMaterial color={DARK} />
      </mesh>
      <mesh position={[0, 1.66, 0]}>
        <cylinderGeometry args={[0.13, 0.26, 0.32, 10, 1, true]} />
        <meshStandardMaterial
          color="#e9d9b8"
          emissive="#ffc27a"
