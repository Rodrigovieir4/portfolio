          ...
          {certifications.map((certificate) => {
            ...
            return (
              <RevealItem key={certificate.id}>
                ...
                >
                  <span className="mt-0.5 grid h-9 w-9 shrink-0 place-items-center rounded-md border border-line bg-elevated text-muted-foreground transition-colors group-hover:border-signal/40 group-hover:text-signal">
